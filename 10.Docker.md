...
daemon off;  #最前面添加一行
[root@Linux-node1-salt ~]# docker commit -m "My Nginx" 7f639bc6646b jackli/nginx:v1 #生成镜像，设置仓库名称和软件名称，版本号，
...
https://github.com/chenjr0719/Docker-Ubuntu-Unity-noVNC/raw/master/docker.jpg

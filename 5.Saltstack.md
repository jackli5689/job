...
##keepalived部署：
[root@SaltstackServer /srv/salt/prod/modules/keepalived]# vim install.sls
---------------------------------------------------------
...
/etc/keepalived:
  file.directory:
    ...
    - group: root
---------------------------------------------------------
[root@SaltstackServer /srv/salt/prod/modules/keepalived/files]# ls
keepalived-1.2.17.tar.gz  keepalived.init  keepalived.sysconfig
[root@SaltstackServer /srv/salt/prod/modules/keepalived/files]# cat keepalived.init
---------------------------------------------------------                                                                                                         
#!/bin/sh
#
...
exit $RETVAL
---------------------------------------------------------
[root@SaltstackServer /srv/salt/prod/modules/keepalived/files]# cat keepalived.sysconfig
---------------------------------------------------------
...
[root@SaltstackServer /srv/salt]# tree
.
├── base
│   ├── init
│   │   ├── audit.sls
